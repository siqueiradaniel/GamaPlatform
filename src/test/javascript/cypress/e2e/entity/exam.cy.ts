...
describe('Exam e2e test', () => {
  ...
  describe('new Exam page', () => {
    ...
    it('should create an instance of Exam', () => {
      cy.get(`[data-cy="name"]`).type('about');
      cy.get(`[data-cy="name"]`).should('have.value', 'about');

      cy.get(`[data-cy="description"]`).type('ha suspension');
      cy.get(`[data-cy="description"]`).should('have.value', 'ha suspension');
