...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '641ad273-5211-4f8d-9130-be7184a59699' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('e8211308-ef38-4e42-b165-8548d770ee06');
      cy.get(`[data-cy="name"]`).should('have.value', 'e8211308-ef38-4e42-b165-8548d770ee06');
