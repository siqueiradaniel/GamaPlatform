...
describe('Subcontent e2e test', () => {
  ...
  describe('new Subcontent page', () => {
    ...
    it('should create an instance of Subcontent', () => {
      cy.get(`[data-cy="name"]`).type('oxygenate overreact unlike');
      cy.get(`[data-cy="name"]`).should('have.value', 'oxygenate overreact unlike');

      cy.get(`[data-cy="description"]`).type('marvelous regarding');
      cy.get(`[data-cy="description"]`).should('have.value', 'marvelous regarding');
