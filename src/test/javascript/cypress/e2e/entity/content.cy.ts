...
describe('Content e2e test', () => {
  ...
  describe('new Content page', () => {
    ...
    it('should create an instance of Content', () => {
      cy.get(`[data-cy="name"]`).type('along');
      cy.get(`[data-cy="name"]`).should('have.value', 'along');

      cy.get(`[data-cy="description"]`).type('down after');
      cy.get(`[data-cy="description"]`).should('have.value', 'down after');
