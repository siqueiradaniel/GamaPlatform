...
/**
 * REST controller for managing {@link org.gama.platform.domain.PendingStudentSubcontent}.
 */
@RestController
...
public class PendingStudentSubcontentResource {
    ...
    public ResponseEntity<PendingStudentSubcontentDTO> createPendingStudentSubcontent(
        @RequestBody PendingStudentSubcontentDTO pendingStudentSubcontentDTO
