...
/**
 * REST controller for managing {@link org.gama.platform.domain.Subcontent}.
 */
@RestController
...
public class SubcontentResource {
    ...
    public ResponseEntity<SubcontentDTO> createSubcontent(@RequestBody SubcontentDTO subcontentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/subcontents/" + subcontentDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, subcontentDTO.getId().toString()))
            .body(subcontentDTO);
    }
    ...
    public ResponseEntity<SubcontentDTO> updateSubcontent(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, subcontentDTO.getId().toString()))
            .body(subcontentDTO);
    }
    ...
    public ResponseEntity<SubcontentDTO> partialUpdateSubcontent(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, subcontentDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<SubcontentDTO> getSubcontent(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteSubcontent(@PathVariable("id") Long id) {
